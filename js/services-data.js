...
const DFK_SERVICES = [
  {
    ...
    cases: [
      // One entry per case PDF. "file" is just the filename — the PDF itself
      // lives in the case-studies/ folder on the server, uploaded separately.
      // { title: "Example Case Name", file: "example-case-name.pdf" },
    ]
  },
  {
